...
namespace Umbraco.Tests.UnitTest.Base
{
	...
	public abstract class BaseDatabaseFactoryTest : BaseUmbracoApplicationTest
	{
		...
		private Umbraco.Core.Persistence.DefaultDatabaseFactory _dbFactory;
		...
		protected UmbracoContext GetUmbracoContext(string url, string nodeContent, RouteData routeData = null, bool setSingleton = false)
		{
			var cache = new PublishedContentCache();
